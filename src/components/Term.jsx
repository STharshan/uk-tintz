          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to UKTintz.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>UKTintz</strong></p>
                          <p>Email: <a href="mailto:Peterattaway1987@gmail.com" className="text-red-500 hover:underline">Peterattaway1987@gmail.com</a></p>
                          <p>Phone: 07506 717 961</p>
                          <p>Address: Unit 6. Broxtowe Park Business Centre Calverton Drive Nottingham NG8 6QP</p>
                      </div>
                  </section>
              </div>
          </div>
